...
public abstract class AlgorithmTask implements Runnable {
	public abstract int getProgressPercentage();
	protected CallbackIntf callbackObj;
	public void setCallback (CallbackIntf callbackObj_p) { this.callbackObj = callbackObj_p; }
