...
/**
 * To indicate the read process has been interrupted by the reader listener.
 * @author Yaxiong Lin
 *
 */
public class ReaderInterruptedException extends Exception {

	public ReaderInterruptedException (String msg_p) {
		super(msg_p);
	}
}
